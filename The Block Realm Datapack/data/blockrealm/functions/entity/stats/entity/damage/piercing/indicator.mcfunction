...
data merge block 0 256 0 {Text1:"[{\"text\":\"-\",\"color\":\"white\"},{\"score\":{\"name\":\"@e[type=!item,tag=indicator,sort=nearest,limit=1]\",\"objective\":\"PiDamageDisplay\"},\"color\":\"white\"},{\"text\":\".\",\"color\":\"white\"},{\"score\":{\"name\":\"@e[type=!item,tag=indicator,sort=nearest,limit=1]\",\"objective\":\"DotPiDamageDisplay\"},\"color\":\"white\"}]"}
data modify entity @e[type=item,tag=indicator,limit=1] CustomName set from block 0 256 0 Text1
