...
data merge block 0 256 0 {Text1:"[{\"text\":\"-\",\"color\":\"red\"},{\"score\":{\"name\":\"@e[type=!item,tag=indicator,sort=nearest,limit=1]\",\"objective\":\"PiDamageDisplay\"},\"color\":\"red\"},{\"text\":\".\",\"color\":\"red\"},{\"score\":{\"name\":\"@e[type=!item,tag=indicator,sort=nearest,limit=1]\",\"objective\":\"DotPiDamageDisplay\"},\"color\":\"red\"}]"}
