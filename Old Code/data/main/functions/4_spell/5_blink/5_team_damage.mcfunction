execute unless score @e[limit=1,sort=nearest,scores={Playing=1}] Team = @s Team run scoreboard players operation @e[sort=nearest,limit=1,scores={Playing=1}] EnergyDamage += @s BaseAbilityDA
