...
scoreboard players operation @s 9_Timer = @s BaseAbilityRC
scoreboard players operation @s LastSpellUsed = #System LastSpellUsed
scoreboard players set @s AbilitiesUsed 1

scoreboard players operation @s SkillCharge = @s SpellItemID
scoreboard players set @s SkillCharging 60
