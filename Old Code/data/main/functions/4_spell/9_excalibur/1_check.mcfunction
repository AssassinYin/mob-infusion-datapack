scoreboard players operation @s DisplayTimer = @s 9_Timer
scoreboard players operation @s DisplayTimer /= 20 Const
execute if score @s Use matches 1.. run function main:4_spell/9_excalibur/2_condition
...
execute if score @s SkillCharge = @s SpellItemID if score @s SkillCharging matches 0 if predicate main:sneaking at @s positioned ~ ~1.25 ~ run function main:4_spell/9_excalibur/4_cast
execute if score @s SkillCharge = @s SpellItemID if score @s SkillCharging matches 0 unless predicate main:sneaking at @s positioned ~ ~1.55 ~ run function main:4_spell/9_excalibur/4_cast
