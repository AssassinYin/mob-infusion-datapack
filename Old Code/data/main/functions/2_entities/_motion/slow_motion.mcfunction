...
#result/Motion
execute store result entity @s Motion[0] double 0.0005 run scoreboard players get @s MotionX2
execute store result entity @s Motion[1] double 0.0005 run scoreboard players get @s MotionY2
execute store result entity @s Motion[2] double 0.0005 run scoreboard players get @s MotionZ2
