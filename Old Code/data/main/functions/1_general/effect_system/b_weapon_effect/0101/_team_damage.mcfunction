##the_abyss
execute unless score @e[limit=1,sort=nearest,scores={Playing=1}] Team = @s Team run scoreboard players add @e[limit=1,sort=nearest,scores={Playing=1}] SweepingDamage 100000
