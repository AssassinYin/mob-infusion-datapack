#silver_trace
scoreboard players add @e[limit=1,sort=nearest,scores={Playing=1}] SweepingDamage 600000
scoreboard players add @e[limit=1,sort=nearest,scores={Playing=1}] AirborneTimer 20
