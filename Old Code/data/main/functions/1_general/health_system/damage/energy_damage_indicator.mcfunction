...
#summon item ~ ~1.5 ~ {CustomModelData:1b,Tags:["new"],PickupDelay:100,Age:5985,CustomNameVisible:1b,CustomName:'{"text":"null"}',Item:{id:"minecraft:blue_wool",Count:1b},Motion:[0.0,0.2,0.0]}
execute at @s run summon area_effect_cloud ^ ^ ^ {CustomNameVisible:1b,Duration:30,Motion:[0.0,0.0,0.0],Tags:["new"],CustomName:'{"text":""}'}

data merge block 0 255 0 {Text1:"[\"\",{\"text\":\"-\",\"color\":\"blue\"},{\"score\":{\"name\":\"@e[sort=nearest,tag=this]\",\"objective\":\"EnergyDisplay\"},\"color\":\"blue\"},{\"text\":\".\",\"color\":\"blue\"},{\"score\":{\"name\":\"@e[sort=nearest,tag=this]\",\"objective\":\".EnergyDisplay\"},\"color\":\"blue\"}]"}
