...
#result/Motion
execute store result entity @s Motion[0] double 0.001 run scoreboard players get #x2 temp
execute store result entity @s Motion[1] double 0.001 run scoreboard players get #y2 temp
execute store result entity @s Motion[2] double 0.001 run scoreboard players get #z2 temp
