...
scoreboard players operation #temp temp += @s ArmorHealth1
scoreboard players operation #temp temp += @s ArmorHealth2
scoreboard players operation #temp temp += @s ArmorHealth3
scoreboard players operation #temp temp += @s ArmorHealth4

#end
scoreboard players operation @s MaxHealth = #temp temp
