...
#effect
scoreboard players operation #temp temp += @s AttackDamageEffect
...
scoreboard players operation #temp temp += @s ArmorAttackDamage1
scoreboard players operation #temp temp += @s ArmorAttackDamage2
scoreboard players operation #temp temp += @s ArmorAttackDamage3
scoreboard players operation #temp temp += @s ArmorAttackDamage4

#end
scoreboard players operation @s AttackDamage = #temp temp
...
#effect
scoreboard players operation #temp temp += @s AttackSpeedEffect
...
scoreboard players operation #temp temp += @s ArmorAttackSpeed1
scoreboard players operation #temp temp += @s ArmorAttackSpeed2
scoreboard players operation #temp temp += @s ArmorAttackSpeed3
scoreboard players operation #temp temp += @s ArmorAttackSpeed4

#end
scoreboard players operation @s AttackSpeed = #temp temp
...
scoreboard players operation #temp temp += @s ArmorEnergy1
scoreboard players operation #temp temp += @s ArmorEnergy2
scoreboard players operation #temp temp += @s ArmorEnergy3
scoreboard players operation #temp temp += @s ArmorEnergy4

#end
scoreboard players operation @s MaxEnergy = #temp temp
