...
$execute if score @s AirbTime matches 1.. run bossbar set minecraft:bossbar$(bid) color yellow

$execute if score @s Shield matches ..0 run bossbar set bossbar$(bid) name [{"text":"Health: ","color":"red"},{"score":{"name":"@s","objective":"HealthDisplay"},"color":"red"},{"text":".","color":"red"},{"score":{"name":"@s","objective":"DotHealthDisplay"},"color":"red"},{"text":"/","color":"red"},{"score":{"name":"@s","objective":"MaxHealthDisplay"},"color":"red"},{"text":".","color":"red"},{"score":{"name":"@s","objective":"DotMaxHealthDisplay"},"color":"red"}]
