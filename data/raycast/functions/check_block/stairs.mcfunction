...
execute if block ~ ~ ~ #minecraft:stairs[facing=north] run function raycast:check_block/transforms/rotate_90
execute if block ~ ~ ~ #minecraft:stairs[facing=west] run function raycast:check_block/transforms/rotate_180
execute if block ~ ~ ~ #minecraft:stairs[facing=south] run function raycast:check_block/transforms/rotate_270
