...
execute at @s if score %chainTriggerTime raycast matches 1.. if entity @e[sort=nearest,tag=!raycaster,tag=!this,tag=!hit,distance=..10] run function raycast:chain
