...
$summon chicken ~ ~ ~ {HasVisualFire:0b,NoGravity:$(noGravity)b,Silent:$(silent)b,Invulnerable:1b,Glowing:0b,CustomNameVisible:0b,FallFlying:1b,NoAI:0b,Health:255f,InLove:0,Age:-32768,ForcedAge:-32768,IsChickenJockey:0b,EggLayTime:-32768,Motion:[0.0,0.0,0.0],Tags:["projectile","motion"]}
