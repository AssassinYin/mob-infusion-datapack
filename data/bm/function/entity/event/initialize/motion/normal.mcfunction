### Apply a normal motion on executor ###
...
#motion result
execute store result entity @s Motion[0] double 0.001 run scoreboard players get &dx Temp
execute store result entity @s Motion[1] double 0.001 run scoreboard players get &dy Temp
execute store result entity @s Motion[2] double 0.001 run scoreboard players get &dz Temp
