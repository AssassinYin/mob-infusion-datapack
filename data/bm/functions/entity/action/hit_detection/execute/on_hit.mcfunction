...
execute if score .isPotionHit temp matches 1 run function bm:entity/action/hit_detection/execute/find_arrow_id
execute if score .isArrowHit temp matches 1 run function bm:entity/action/hit_detection/execute/find_arrow_id
