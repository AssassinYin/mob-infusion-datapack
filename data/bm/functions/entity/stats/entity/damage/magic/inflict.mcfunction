...
execute if score @s Shield matches 0 run function bm:entity/stats/entity/damage/magic/cal_armor_protection
...
#indicator
execute at @s run function bm:entity/stats/entity/damage/magic/indicator
