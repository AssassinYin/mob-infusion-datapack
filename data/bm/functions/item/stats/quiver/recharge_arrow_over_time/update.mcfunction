...
execute if entity @s[nbt={Inventory:[{Slot:-106b}]}] unless entity @s[nbt={Inventory:[{Slot:-106b,tag:{shouldBeInOffhand:1}}]}] run function bm:item/stats/quiver/recharge_arrow_over_time/swap_offhand

execute if score .quiver.rechargeTime temp >= .quiver.rechargePerTick temp if score .quiver.current temp matches 1.. run function bm:item/stats/quiver/recharge_arrow_over_time/has_arrow
execute if score .quiver.rechargeTime temp >= .quiver.rechargePerTick temp if score .quiver.current temp matches 0 run function bm:item/stats/quiver/recharge_arrow_over_time/has_no_arrow
